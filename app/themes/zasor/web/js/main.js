...
$('.sub-link').hover(function () {
    ...
    $(this).parents('.sub-item').find('.sub-sub-menu').addClass('active');
});
...
$("input.fl_inp").change(function () {
    ...
    $(this).parent().next(".fl_nm").addClass('active');
    $(this).parent().next(".fl_nm").html(filename);
});
...
const sliderService = new Swiper(".service-slider", {
    slidesPerView: 3,
    spaceBetween: 88,
    loop: true,
    loopedSlides: 3,
