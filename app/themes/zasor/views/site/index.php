                ...
                <ul class="main-services-block">
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/ustranenie-zasora/12.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Промывка канализации</h3>
                            <div class="text-main-services-content">Промывка канализации. В результате интенсивной работы системы водоотведения в канализации скапливается песок, жир и ил. В результате засора блокируется движение воды, что может привести к поломке оборудования. Чтобы удалить скопившуюся грязь, мы подаем в трубопровод воду под большим напором. Этот способ эффективен против стойких загрязнений, но не подходит для удаления твердых предметов: камней, дерева, металла.</div>
                            <div class="btn-main-services">
                                <a href="/gidrodinamicheskaya-promyvka-kanalizacii.html">Подробнее</a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/elektro-mekhanicheskaya-chistka-trub/1.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Прочистка канализации</h3>
                            <div class="text-main-services-content">Прочистка канализации. С большей частью засорений помогает справиться прочистка пружинным тросом со специальными насадками. Этот метод подходит для труб длиной до 15 метров. Если трубы длиннее, то для прочистки используется трос с электроприводом.</div>
                            <div class="btn-main-services">
                                <a href="/mehanicheskaya-chistka-kanalizacii.html">Подробнее</a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/video-diagnostika-trub/9.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Обследование канализации</h3>
                            <div class="text-main-services-content">Обследование канализации. В процессе эксплуатации трубы могут треснуть или просесть. Устранить неисправность можно с помощью перекладки труб или ремонта проблемной зоны. Чтобы быстро обнаружить поврежденный участок, мы используем эндоскопы — специальные приборы для видео обследования труб.</div>
                            <div class="btn-main-services">
                                <a href="/obsledovanie-trub.html">Подробнее</a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/parogenerator/2.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Аренда парогенератора</h3>
                            <div class="text-main-services-content"> 4 000 рублей час Минимум 4 часа аренды</div>
                            <div class="btn-main-services">
                                <a href="/parogenerator.html">Подробнее</a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/otkachka-zhiroulovitelya/1.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Прочистка жироуловителей</h3>
                            <div class="text-main-services-content">Прочистка жироуловителей. Для очистки сточных вод от ила и жира на промышленных предприятиях в канализацию устанавливают жироуловитель. Чтобы резервуар не переполнялся, нужно своевременно производить очистку с помощью илососа.</div>
                            <div class="btn-main-services">
                                <a href="/ochistka-chistka-zhiroulovitelya.html">Подробнее</a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/chistka-kns-los/11.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Обслуживание КНС</h3>
                            <div class="text-main-services-content">Обслуживание канализационных насосных станций (КНС). В процессе эксплуатации узлы канализационной насосной станции засоряются иловыми отложениями, которые не дают оборудованию работать. Чтобы избежать выхода системы из строя, нужно регулярно откачивать ил из КНС.</div>
                            <div class="btn-main-services">
                                <a href="/obsluzhivanie-kns.html">Подробнее</a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/assenizator/2.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Услуги илососа</h3>
                            <div class="text-main-services-content">Услуги илососа. Вы можете взять в аренду илосос, чтобы откачать бытовые отходы высокой плотности, в том числе, жир и ил. Установка работает по принципу ассенизаторской машины, но отличается более мощным насосом.</div>
                            <div class="btn-main-services">
                                <a href="/uslugi-ilososa.html">Подробнее</a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/otkachka-avtomoek/5.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Очистка автомоек</h3>
                            <div class="text-main-services-content">Очистка автомоек. Чтобы ликвидировать твердые отходы и грязь из автомойки, используют илосос. Для этого рукав высокого давления заглубляют внутрь трубы и под большим напором подают воду. После этого откачивают грязь из накопительного резервуара. </div>
                            <div class="btn-main-services">
                                <a href="/otkachka-avtomoek.html">Подробнее</a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/chistka-dna-vygrebnoj-yamy/10.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Откачка выгребных ям</h3>
                            <div class="text-main-services-content">Откачка выгребных ям. Самый простой и недорогой способ организовать канализацию в частном доме или на даче — выкопать выгребную яму, в которую будут поступать жидкие отходы. По мере наполнения воду из ямы нужно откачивать. Для этого мы используем ассенизаторскую машину или илосос. </div>
                            <div class="btn-main-services">
                                <a href="/otkachka-vygrebnyh-yam.html">Подробнее</a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/chistka-kns-los/9.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Откачка септиков</h3>
                            <div class="text-main-services-content">Откачка септиков и выгребных ям. Производится с помощью ассенизаторских машин, которые предназначены для выкачки и транспортировки грязи из септиков и выгребных ям. </div>
                            <div class="btn-main-services">
                                <a href="/obsluzhivanie-kns.html">Подробнее</a>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/assenizator/1.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Услуги ассенизатора</h3>
                            <div class="text-main-services-content">Услуги ассенизатора. Осушить подвал, канализацию, котлован или ливневку поможет ассенизаторская машина. Эту технику используют также для откачки воды из водоемов.</div>
                            <div class="btn-main-services">
                                <a href="/uslugi-assenizatora.html">Подробнее</a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="img-main-services">
                            <img src="images/uslugi/razmorozka-trub/1.webp" loading="lazy" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Разморозка труб</h3>
                            <div class="text-main-services-content">Разморозка канализационных труб. Из-за образования в трубопроводе ледяных пробок система не может нормально работать. Чтобы не допустить повреждения коммуникаций и аварийных ситуаций, трубы нужно размораживать при малейших признаках образования наледи на них.</div>
                            <div class="btn-main-services">
                                <a href="/razmorozka-trub.html">Подробнее</a>
                            </div>
                        </div>
                    </li>
                    <!-- <li>
                        <div class="img-main-services">
                            <img src="images/serv-kamaz.webp" alt="">
                        </div>
                        <div class="text-main-services">
                            <h3>Разморозка труб</h3>
                            <div class="text-main-services-content">Услуги по разморозке металлических и пластиковых труб с использованием эффективных методов. Звоните!</div>
                            <div class="btn-main-services">
                                <a href="#">Подробнее</a>
                            </div>
                        </div>
