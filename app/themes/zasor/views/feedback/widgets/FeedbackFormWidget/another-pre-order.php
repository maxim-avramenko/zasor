...
<div class="form">
        ...
        array(
            ...
            'clientOptions'=>array(
                ...
                'beforeValidate' => 'js:function(form){
                    $("#preOrder input[type=submit]").prop("disabled", true);
                    return true;
                }',
                'afterValidate'=>'js:function(form,data,hasError){
                $("#preOrder input[type=submit]").prop("disabled", false);
                console.log(data);
                console.log(hasError);
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        console.log(data);
                                              $("form#preOrder")[0].reset();
                                                $(".pre-order-form#preOrder .success-bg").addClass("open");
                                                setTimeout(function() {
                                                    $(".pre-order-form#preOrder .success-bg").removeClass("open");
                                                }, 5000);
                                    }
                                });
    ...
    <?php  echo CHtml::submitButton(Yii::t('app', 'Send subscribe'), ['class' => 'btn btn-lg']); ?>
