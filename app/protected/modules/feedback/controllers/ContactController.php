...
class ContactController extends \yupe\components\controllers\FrontController
{
     ...
     * @param null $type
     */
    public function actionVacancies($type = null)
    {
        $form = new FeedBackForm();
...
//            print_r($form->getUploadedFileInstance());
...
//            print_r($form->attributes);
            ...
            if ($form->validate() ) {
                ...
                if ($this->feedback->send($form, $module)) {
                    ...
                    $this->redirect(
                        $module->successPage ? [$module->successPage] : ['/feedback/contact/vacancies/']
                    );
                } else {
        ...
        $this->render('vacancies', ['model' => $form, 'module' => $module]);
    }
    /**
     *
     */
