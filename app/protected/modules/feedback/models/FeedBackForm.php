...
class FeedBackForm extends CFormModel implements IFeedbackForm
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            ['name, email, phone, city', 'length', 'max' => 150],
            ['theme', 'length', 'max' => 250],
            ['attach', 'file', 'maxSize' => $yupe->maxSize, 'types' => $yupe->allowedExtensions, 'allowEmpty' => true],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'text' => Yii::t('FeedbackModule.feedback', 'Расскажите о себе'),
            'verifyCode' => Yii::t('FeedbackModule.feedback', 'Check code'),
            'type' => Yii::t('FeedbackModule.feedback', 'Type'),
            'attach' => Yii::t('FeedbackModule.feedback', 'Файл'),
