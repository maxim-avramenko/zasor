...
/**
 * ServicesRssController контроллер для генерации rss-ленты новостей
 *
 ...
 *
 */
class ServicesRssController extends yupe\components\controllers\RssController
{
    public function loadData()
    {
        ...
        $this->data = Services::model()->cache($this->yupe->coreCacheTime)->with('user')->published()->public()->findAll(
            $criteria
        );
    }
