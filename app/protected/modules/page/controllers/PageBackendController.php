...
/**
 * PageBackendController контроллер для работы с новостями в панели управления
 *
...
class PageBackendController extends yupe\components\controllers\BackController
{
    ...
    public function actionCreate()
    {
        ...
        if (!empty($id) && !empty($lang)) {
            ...
            if (null === $page) {
                ...
                $this->redirect(['/page/pageBackend/create']);
            }
    ...
    public function actionDelete($id = null)
    {
        if (Yii::app()->getRequest()->getIsPostRequest()) {
            ...
            throw new CHttpException(
                400,
                Yii::t('PageModule.page', 'Bad raquest. Please don\'t use similar requests anymore!')
            );
        }
    }
    ...
    public function loadModel($id)
    {
        if (($model = Page::model()->findByPk($id)) === null) {
            throw new CHttpException(
                404,
                Yii::t('PageModule.page', 'Requested page was not found!')
            );
        }
