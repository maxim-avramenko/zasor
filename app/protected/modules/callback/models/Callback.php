...
class Callback extends \yupe\models\YModel
{
    ...
    const TYPE_FILEBACK = 1;
    const TYPE_CONTACTS = 2;
    ...
    {
        return [
            ['phone, agree', 'required'], // Только телефон и согласие обязательны
            ['name', 'safe'], // Имя не обязательно
            ...
            ['comment,email, attach', 'length', 'max' => 255],
            ['status, type', 'numerical', 'integerOnly' => true],
            ['url', 'url'],
            ['id, name, phone, time, comment, status, create_time, url, agree, email, attach', 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'email' => Yii::t('CallbackModule.callback', 'Email'),
    ...
    public function behaviors()
    {
        return [
            ...
            'fileUpload' => [
                ...
                'types' => 'docx,pdf,doc,txt,rtf,ppt,pptx,jpg,jpeg,png,gif,zip,rar',
    ...
    public function getTypeList()
    {
        return [
            ...
            self::TYPE_CONTACTS => 'Обратный звонок с контактов',
            self::TYPE_FILEBACK => 'Обратный звонок с файлом',
        ];
    }
