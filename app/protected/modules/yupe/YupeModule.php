...
class YupeModule extends WebModule
{
    ...
    public function getParamsLabels()
    {
        return [
            ...
            'companyMap' => Yii::t('YupeModule.yupe', 'companyMap'),
            'companyCountry' => Yii::t('YupeModule.yupe', 'companyCountry'),
            'companyRegion' => Yii::t('YupeModule.yupe', 'companyRegion'),
            'companyCity' => Yii::t('YupeModule.yupe', 'companyCity'),
    ...
    public function getEditableParamsGroups()
    {
        return [
            ...
            'Company' => [
                'label' => Yii::t('YupeModule.yupe', 'Company'),
                'items' => [
                    'companyMap',
                    'companyCountry',
                    'companyRegion',
