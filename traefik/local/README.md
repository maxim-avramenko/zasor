...
docker network create mailchecker && \
docker network create accounts && \
docker network create boiler && \
docker network create renat && \
docker network create console && \
docker network create constellator && \
docker network create tickets
